...
// The game and its undo stack, and the open modal ({name, arg}); other modules read them as live bindings and change them through the setters.
...
// What modals.js and the page entry point use.
export {
  showErrBar,
  ringIcon,
  RING_PATH,
