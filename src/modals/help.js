...
function helpHTML() {
  return (
    ...
    "<h3>The board tracker</h3><p>Keep it up to date: it answers questions about the Fellowship, minions, nations and factions for you, and decides which of Queller’s cards can be played without showing you the rest of the hand. A minion set to eliminated is never mustered again. Card checks it asks you about are remembered for the turn; press Forget if the board has changed.</p>" +
