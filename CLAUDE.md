...
- `src/flow/anchors.json` is generated: after a draw.io change, regenerate it with `sync_anchors.py` (which must write that path as JSON) rather than editing it.
